        ...
        VStack {
            ...
            VStack(alignment: .leading, spacing: nil, content: {
                ...
                ScrollView(.vertical){
                    ...
                    Spacer()
                    Link("Learn More Here!", destination: URL(string: models[index].link)!)
                }
